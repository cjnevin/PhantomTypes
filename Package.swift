...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "MonoidTypes", url: "https://github.com/cjnevin/MonoidTypes", from: "1.0.2"),
        .package(name: "WrappedTypes", url: "https://github.com/cjnevin/WrappedTypes", from: "1.0.1")
    ],
    targets: [
